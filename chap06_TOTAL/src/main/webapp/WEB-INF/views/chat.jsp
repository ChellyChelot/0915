...
<div align="center" style="margin: 10px;">
	...
	<div style="width: 80%; height:70%; background-color: #D5D5D5; font-size: 10pt;" align="left" id="log">
	</div>
...
<script>
	...
	var ws = new WebSocket("ws://192.168.10.65/ws/chat");
	...
	ws.onerror=function(e) {
		if(window.confirm("채팅서버 접속 실패\n다시 접속하시겠습니까?")) {
			ws =new WebSocket("ws://192.168.10.65/ws/chat");
		}
	}
